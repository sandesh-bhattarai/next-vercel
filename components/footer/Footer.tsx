export const HomeFooter = () => {
  return (
    <>
      {/* Footer */}
      <footer className="bg-white dark:bg-teal-900">
          ...
          <div className="mx-auto max-w-md">
            ...
            <form className="mt-6">
              <div className="relative max-w-lg">
                ...
                <input
                  className="w-full rounded-full border-gray-200 bg-gray-100 p-4 pe-32 text-sm font-medium dark:border-teal-700 dark:bg-teal-800 dark:text-white"
                  id="email"
                  type="email"
